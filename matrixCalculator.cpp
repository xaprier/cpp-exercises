...
int main() {
    ...
    system("cls");
    a:
    cout << "Aşağıdaki seçeneklerden bir tanesini seçiniz...\n1 - Skaler Çarpım\n2 - Matris Çarpım\n3 - Skaler Toplam\n4 - Matris Toplam\n5 - Skaler Çıkarma\n6 - Matris Çıkarma\n7 - Transpoz\n8 - Çıkış" << endl;
    cin >> secenekduzeltme;
    ...
    switch (secenek) {
        case 1: {
            ...
            int carpilacaksayi; cout << "Çarpılacak sayıyı giriniz: "; cin >> carpilacaksayi;
        ...
        case 2: {
            cout << "2.Matrisin Sütun Sayısını Giriniz: "; int p; cin >> p;
            int **dizi2 = new int *[n];
        ...
        case 3: {
            ...
            int toplancaksayi; cout << "Toplanacak sayıyı giriniz: "; cin >> toplancaksayi;
        ...
        case 5: {
            ...
            int cikarilacaksayi; cout << "Çıkarılacak sayıyı giriniz: "; cin >> cikarilacaksayi;
            // başlıklar, dizimizin bastırılması ve dizimizin yeni halinin atanması
        ...
        case 6: {
            ...
            for (int i = 0; i < m; i++) { for (int j = 0; j < n; j++) { cout << "2.Matrisin " << i << "x" << j << " konumunu giriniz: "; /*dizi2[i][j] = rand() % 9 + 1;*/ cin >> dizi2[i][j]; } }
            // 1.dizi ve 2.dizinin bastırılması ve başlıklar
            cout << "1.Matris" << endl; matrisBastir(dizi1, m, n); cout << "2.Matris" << endl; matrisBastir(dizi2, m, n); cout << "Çıkarım Sonucu" << endl;
            // sonuc dizisinin oluşturulması ve değerin atanması ve bastırılması
